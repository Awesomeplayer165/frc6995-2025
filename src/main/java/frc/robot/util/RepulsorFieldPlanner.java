...
public class RepulsorFieldPlanner {
    ...
    static class VerticalObstacle extends Obstacle {
        ...
        public Force getForceAtPosition(Translation2d position, Translation2d target) {
            return new Force(
                    ...
                    distToForceMag(x - position.getX(), 1), 0);
        }
    }
    ...
    public static final List<Obstacle> FIELD_OBSTACLES = List.of(
            new SnowmanObstacle(new Translation2d(4.539, FIELD_WIDTH / 2), 1.187, true),
            new SnowmanObstacle(new Translation2d(13.108, FIELD_WIDTH / 2), 1.187, true));
    ...
    public RepulsorFieldPlanner() {
        ...
        NetworkTableInstance.getDefault().startEntryDataLog(DataLogManager.getLog(), "SmartDashboard/Alerts",
    ...
    // Reefscape Points of Interest (POIs) on the field
    public static final List<POIInfo> POIs = List.of(
        // Blue
        new POIInfo("Algae center", Alliance.Blue, new Pose2d(1.268, FIELD_WIDTH / 2, new Rotation2d(0))),
        new POIInfo("Algae left", Alliance.Blue,
                new Pose2d(1.268, (FIELD_WIDTH / 2) + 1.829, new Rotation2d(0))),
        new POIInfo("Algae right", Alliance.Blue,
                new Pose2d(1.268, (FIELD_WIDTH / 2) - 1.829, new Rotation2d(0))),

        new POIInfo("Reef", Alliance.Blue, new Pose2d(4.539, FIELD_WIDTH / 2, new Rotation2d(0))),
        new POIInfo("Coral Substation left", Alliance.Blue,
                new Pose2d(0.901, 0.615, Rotation2d.fromDegrees(234))),
        new POIInfo("Coral Substation right", Alliance.Blue,
                new Pose2d(0.901, FIELD_WIDTH - 0.615, Rotation2d.fromDegrees(126))),
        new POIInfo("Reef17", Alliance.Blue,
                new Pose2d(3.9, (FIELD_WIDTH / 2) - 1.028, Rotation2d.fromDegrees(60))),
        new POIInfo("Reef18", Alliance.Blue, new Pose2d(3.351, FIELD_WIDTH / 2, new Rotation2d(0))),
        new POIInfo("Reef19", Alliance.Blue,
                new Pose2d(3.9, (FIELD_WIDTH / 2) + 1.028, Rotation2d.fromDegrees(300))),
        new POIInfo("Reef20", Alliance.Blue,
                new Pose2d(5.08, (FIELD_WIDTH / 2) + 1.028, Rotation2d.fromDegrees(240))),
        new POIInfo("Reef21", Alliance.Blue, new Pose2d(5.726, FIELD_WIDTH / 2, Rotation2d.fromDegrees(180))),
        new POIInfo("Reef22", Alliance.Blue,
                new Pose2d(5.08, (FIELD_WIDTH / 2) - 1.028, Rotation2d.fromDegrees(120))),
        new POIInfo("Processor", Alliance.Blue, new Pose2d(6.037, 0.2, Rotation2d.fromDegrees(-90))),
        new POIInfo("Cage left", Alliance.Blue, new Pose2d(8.823, (FIELD_WIDTH / 2) + 3.234, Rotation2d.fromDegrees(0))),
        new POIInfo("Cage center", Alliance.Blue, new Pose2d(8.823, (FIELD_WIDTH / 2) + 2.143, Rotation2d.fromDegrees(0))),
        new POIInfo("Cage right", Alliance.Blue, new Pose2d(8.823, (FIELD_WIDTH / 2) + 1.053, Rotation2d.fromDegrees(0))),

        // Red
        new POIInfo("Algae center", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 1.268, FIELD_WIDTH / 2, Rotation2d.fromDegrees(180))),
        new POIInfo("Algae left", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 1.268, (FIELD_WIDTH / 2) + 1.829, Rotation2d.fromDegrees(180))),
        new POIInfo("Algae right", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 1.268, (FIELD_WIDTH / 2) - 1.829, Rotation2d.fromDegrees(180))),

        new POIInfo("Reef", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 4.539, FIELD_WIDTH / 2, Rotation2d.fromDegrees(180))),
        new POIInfo("Coral Substation left", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 0.901, 0.615, Rotation2d.fromDegrees(306))),
        new POIInfo("Coral Substation right", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 0.901, FIELD_WIDTH - 0.615, Rotation2d.fromDegrees(54))),
        new POIInfo("Reef11", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 3.9, (FIELD_WIDTH / 2) - 1.028,
                        Rotation2d.fromDegrees(-60).minus(Rotation2d.fromDegrees(180)))),
        new POIInfo("Reef10", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 3.351, FIELD_WIDTH / 2, Rotation2d.fromDegrees(180))),
        new POIInfo("Reef9", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 3.9, (FIELD_WIDTH / 2) + 1.028,
                        Rotation2d.fromDegrees(-300).minus(Rotation2d.fromDegrees(180)))),
        new POIInfo("Reef8", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 5.08, (FIELD_WIDTH / 2) + 1.028,
                        Rotation2d.fromDegrees(-240).minus(Rotation2d.fromDegrees(180)))),
        new POIInfo("Reef7", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 5.726, FIELD_WIDTH / 2, Rotation2d.fromDegrees(0))),
        new POIInfo("Reef6", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 5.08, (FIELD_WIDTH / 2) - 1.028,
                        Rotation2d.fromDegrees(-120).minus(Rotation2d.fromDegrees(180)))),
        new POIInfo("Processor", Alliance.Red,
                new Pose2d(FIELD_LENGTH - 6.037, FIELD_WIDTH - 0.2, Rotation2d.fromDegrees(90))),

        new POIInfo("Cage left", Alliance.Red, new Pose2d(FIELD_LENGTH - 8.823, (FIELD_WIDTH / 2) - 3.234, Rotation2d.fromDegrees(180))),
        new POIInfo("Cage center", Alliance.Red, new Pose2d(FIELD_LENGTH - 8.823, (FIELD_WIDTH / 2) - 2.143, Rotation2d.fromDegrees(180))),
        new POIInfo("Cage right", Alliance.Red, new Pose2d(FIELD_LENGTH - 8.823, (FIELD_WIDTH / 2) - 1.053, Rotation2d.fromDegrees(180))));

    public Pose2d[] POIsPoses = POIs.stream().map(poi -> poi.pose).toArray(Pose2d[]::new);
